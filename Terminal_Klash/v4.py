...
class Player:
    ...
    def attack(self):
        ...
        attack_choice = input("Which attack do you want to use? 1. Punch 2. Laser 3. Heal 15 HP 4. Special Move 5. Blood Drain")
        
        while attack_choice not in ["1", "2", "3", "4", "5"]:
        ...
        if attack_choice == "1":
            ...
            self.hp += damage
            print(f"{self.name} takes {damage} health from the enemy! Hp is now {self.hp}!")
...
enemy_names = ["Zombie", "Skelekton", "Monster", "Hacker", "Bully", "Rival", "Killer", "Tank Warrior"]
